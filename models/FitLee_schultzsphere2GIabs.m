...
'I(q) = f0*(delta\_rho0^2*Sq*P(q; r0, sig0) + Nratio*delta\_rho1^2*P(q; r1, sig1)) + background',...
'    Sq = powI*q.^PorodExp + S(q; D, vf)',...
'    background = poly1*q.^poly2 + poly3*q + poly4',...
'Parameters',...
'  f0 : Number fraction of particle 0 per unit area = N0/S',...
'  delta\_rho0 : electron density difference for particle 0 (A^-3)',...
